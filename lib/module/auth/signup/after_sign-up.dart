                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          MyText(text: 'Step 2 of 2: Basic Info', textStyle: TextStyle(fontWeight: FontWeight.bold, fontSize: AppHelper.helper.getResponsiveTextSize(width, baseSize: 18.0))),
                          SizedBox(height: 20),
                          Divider(),
                          SizedBox(height: 20),
                      ...
                      SizedBox(height: 30),
                      MyCustomButton(onPressed:() => (print('pressed')), text: 'Contineu', width: width, height: 40, textStyle: TextStyle(color: MyColor.white1), color: MyColor.darkBlue),
                    ],
                  ),
                ),
              ),
